          ...
          <div className="">
            {(positiveText || negativeText) && (
              <div className="flex justify-end space-x-3 pt-4 border-t">
                {negativeText && (
                  <button
                    className="transition-all text-white py-1 px-6 md:py-3 md:px-5 flex items-center gap-2 bg-red-600 rounded-md hover:bg-red-700"
                    onClick={onPressNegativeBtn}
                  >
                    {negativeText}
                  </button>
                ...
                {positiveText && (
                  <button
                    type="button"
                    className="bg-[var(--btn-bg)] hover:bg-[var(--btn-hover-bg)] transition-all text-white py-1 px-6 md:py-3 md:px-5 rounded-md flex items-center gap-2"
